...
echo "=== Building DeveloperChatbot Executable for Intel macOS 13 ==="
...
echo "=== Copying built Intel executable ==="
cp ".build/x86_64-apple-macosx/release/DeveloperChatbot" "$MACOS_DIR/DeveloperChatbot"
